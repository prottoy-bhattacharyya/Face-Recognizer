...
![Circuit Diagram](documents/updated_circut.png)
...
│   ├── views.py                # API views (auth, face enrollment/verification, password mgmt)
│   ├── models.py
│   ├── models/yolov8n-face.pt  # Fine-tuned YOLOv8 face detection model
│   └── face_database/          # Per-user enrolled face images (auto-created)
├── firmware/
│   ├── esp8266_access_control/ # ESP8266 #1 — keypad, OLED, face verification trigger
│   └── esp8266_room_automation/# ESP8266 #2 — gate, fan, light, DHT11 web server
├── docs/
│   └── circuit.png              # Fritzing circuit diagram
└── README.md
```
